...
xzFolder.add(param, "xspeed", 0.1, 5.0, 0.01).onChange(() => {
    shaderMaterial.uniforms.xspeed.value = param.xspeed
})
xzFolder.add(param, "yspeed", 0.1, 5.0, 0.01).onChange(() => {
...
noiseFolder.add(param, "nspeed", 0.001, 0.2, 0.0001).onChange(() => {
